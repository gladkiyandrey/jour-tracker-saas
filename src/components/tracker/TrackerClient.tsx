  ...
  const ui = useMemo(() => {
    if (locale === "ru") {
      return {
        ...
        disciplineScoreHint: "Ваш уровень дисциплины за месяц",
    ...
    if (locale === "uk") {
      return {
        ...
        greenStreak: "GREEN STREAK",
        redStreak: "RED STREAK",
        disciplineScoreHint: "Ваш рівень дисципліни за місяць",
    ...
    return {
      ...
      greenStreak: "GREEN STREAK",
      redStreak: "RED STREAK",
      disciplineScoreHint: "Your discipline level for the month",
