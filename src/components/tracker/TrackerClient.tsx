...
function buildPath(
  ...
  minY: number,
  maxY: number,
  bounds = { left: 10, right: 510, top: 30, bottom: 290 }
) {
    ...
    <section className={styles.wrapper}>
      <div className={styles.tracker}>
        <div className={`${styles.panel} ${styles.mainPanel}`}>
          ...
          <svg className={styles.chart} viewBox="0 0 520 320" preserveAspectRatio="none" aria-label="Tracker chart">
            <g>
              ...
              <line className={styles.gridLine} x1="10" y1="290" x2="510" y2="290" />
            </g>
