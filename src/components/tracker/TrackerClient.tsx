  ...
  const ui = useMemo(() => {
    if (locale === "ru") {
      return {
        ...
        disciplineScoreHint: "Зеленый день и дисциплинированный пропуск считаются как дисциплинированные. Красный день считается как нарушение ТС.",
    ...
    if (locale === "uk") {
      return {
        ...
        greenStreak: "GREEN STREAK",
        redStreak: "RED STREAK",
        disciplineScoreHint: "Зелений день і дисциплінований пропуск рахуються як дисципліновані. Червоний день рахується як порушення ТС.",
    ...
    return {
      ...
      greenStreak: "GREEN STREAK",
      redStreak: "RED STREAK",
      disciplineScoreHint: "Green day and disciplined skip count as disciplined. Red day counts as a rule-breaking day.",
